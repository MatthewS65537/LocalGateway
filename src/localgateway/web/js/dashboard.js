...
async function loadDashUsage() {
  ...
  if (!ok) { loadError('usage stats'); return; }
  const t = data.total;
...
async function loadHealth() {
  ...
  if (healthEl && !healthEl.dataset.loaded) {
    healthEl.innerHTML = '<div class="skeleton skeleton-block" style="min-height:80px"></div>';
    rlEl.innerHTML = '<div class="skeleton skeleton-block" style="min-height:80px"></div>';
  }
